...
Text::Text(Config *config) :Renderable(config){}
Text::~Text(){}
void Text::render(){}
...
void Text::configureText(Config *config)
{
	...
	glViewport(0, 0, getConfig()->WINDOW_W, getConfig()->WINDOW_H);
	...
	glm::mat4 projection = glm::ortho(0.0f, static_cast<GLfloat>(getConfig()->WINDOW_W), 0.0f, static_cast<GLfloat>(getConfig()->WINDOW_H));
	shader.Use();
